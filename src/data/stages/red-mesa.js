...
export default { name: 'Red Mesa Canyon', traffic: { on: 0, with: 1 }, blurb: 'Short and savage: five jumps, a rock arch and a mine railway', type: 'gorge', laps: 3, seed: 4242, surface: 'tarmac', hillAmp: 3, jumps: 0, armco: true,
  ...
  segs: (() => {
    ...
    const low = { far: 6, rampF: 14, near: -3, rampN: 16 }, arch = { tunnel: true, far: 26, near: 22 }, ledge = { far: 30, rampF: 5, near: -24, rampN: 10, rockfall: true };
    ...
    return [
      ...
      ['a', 24, 90, 10, low], ['s', { toB: 240 }, 31, climb], ['a', 30, 90, 38, ledge],
      ['a', 200, 12, 40, ledge], ['s', 30, 40, ledge],                                                  // cliff-top ledge (rockfall)
      ['s', 25, 40, { ...stair, kick: 2.4 }], ['a', 100, -24, 32, stair],         // the Staircase: two kicks down
      ['s', 20, 32, { ...stair, kick: 2.4 }], ['a', 100, 12, 24, stair],
      ['a', 30, 90, 23, run], ['a', 50, -40, 21, run], ['a', 50, 80, 19, run], ['a', 50, -40, 18, run],
