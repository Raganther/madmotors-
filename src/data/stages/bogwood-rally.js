// Stage: Bogwood Rally. An autumn forest rally on dirt, built for air and mess: natural crest jumps ('yump'), a run of
...
export default { name: 'Bogwood Rally', blurb: 'Forest dirt: crest jumps, whoops, mud bogs and a water splash', type: 'gorge', laps: 3, seed: 777, surface: 'gravel', hillAmp: 5, jumps: 0, armco: false,
  ...
  segs: (() => {
    ...
    return [
      ['s', 70, 10, wood],                                                        // start
      ['a', 40, 45, 13, wood], ['s', 30, 17, { ...crest, yump: 2.8 }],             // up to the crest...
      ...
      ['s', 30, 2, wood], ['s', 25, 2, { ...crest, yump: 3.2 }], ['s', 35, -4, crest],   // big jump
      ['a', 30, 45, -6, wood], ['s', 34, -8, { ...creek, mud: 'water' }], ['s', 30, -4, wood],   // the water splash
      ['a', 40, 90, 0, bank],
      ['s', 20, 3, { ...wood, yump: 2.5 }], ['s', 22, 3, wood], ['s', 20, 3, { ...wood, yump: 2.5 }],   // double jump
      ['s', 40, 6, wood], ['a', 25, 40, 5, bank], ['a', 25, -40, 4, { ...dip, mud: true }],   // a muddy S-bend...
      ['s', { toB: 30 }, 6, wood], ['a', 30, 90, 8, wood], ['s', { toA: 0 }, 10, { ...wood, yump: 2.4 }]   // ...and a last jump home
    ];
  })() };
