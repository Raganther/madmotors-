...
export const VEHICLES = [
  ...
  { id: 'hatch', name: 'Rally Hatch', model: 'hatch', color: 0xE0402F, accent: 0xFFFFFF, veh: { accel: 1.05, top: 0.955, grip: 1.01, off: 1.12, im: 1.05 }, blurb: 'A 70s stage hero: quick off the line and happy on dirt.' },
  ...
  { id: 'buggy', name: 'Trophy Buggy', model: 'buggy', color: 0x2FB36B, accent: 0xFFFFFF, veh: { accel: 1.0, top: 0.955, grip: 0.97, off: 1.25, im: 1.1 }, blurb: 'Long-travel suspension and knobblies: flies over the rough.' },
  { id: 'monster', name: 'Monster Truck', model: 'monster', color: 0x7A3FD1, accent: 0x9BE22E, hw: 1.2, hl: 1.9, veh: { accel: 0.98, top: 0.945, grip: 0.95, off: 1.3, im: 0.55 }, blurb: 'Wheels taller than you. Rolls over anything, including rivals.' },
  ...
  { id: 'tuktuk', name: 'Tuk-Tuk', model: 'tuktuk', color: 0x2FA84F, accent: 0xFFD21F, hw: 0.9, veh: { accel: 1.07, top: 0.95, grip: 0.95, off: 1.02, im: 1.6 }, blurb: 'Three wheels, a canopy and a lot of heart. Mind the corners.' },
  ...
  { id: 'rover', name: 'Moon Rover', model: 'rover', color: 0xE7E3D6, accent: 0xE8A23A, veh: { accel: 0.98, top: 0.945, grip: 1.04, off: 1.3, im: 0.85 }, blurb: 'Six wheels, a dish and a gold-foil body. Mud? What mud.' },
  { id: 'hover', name: 'Hovercraft', model: 'hover', color: 0x19A7A0, accent: 0xFF6A3D, hw: 1.15, hl: 1.95, veh: { accel: 0.98, top: 0.955, grip: 0.84, off: 1.3, im: 1.2 }, blurb: 'Rides on air: mud, snow and water are all the same to it. Corners? Eventually.' },
  { id: 'snowcat', name: 'Snowcat', model: 'snowcat', color: 0xF07C1E, accent: 0x2B2F3A, hw: 1.25, hl: 1.95, veh: { accel: 0.97, top: 0.935, grip: 1.03, off: 1.34, im: 0.6 }, blurb: 'Tracks, a blade and a beacon. Crawls up anything, never in a hurry on tarmac.' },
  ...
  { id: 'sidecar', name: 'Sidecar Bike', model: 'sidecar', color: 0xC8102E, accent: 0xF4F4F0, hw: 1.15, veh: { accel: 1.08, top: 0.98, grip: 0.96, off: 0.9, im: 1.5 }, blurb: 'A big-bore bike and a brave passenger. Rockets off the line, bounces off everything.' },
  { id: 'mixer', name: 'Cement Mixer', model: 'mixer', color: 0xF2C12E, accent: 0xE8E8E8, hw: 1.05, hl: 2.5, veh: { accel: 0.96, top: 0.985, grip: 0.96, off: 1.02, im: 0.4 }, blurb: 'The drum never stops turning. Neither does it, once it gets going.' }
];
